...
export default function SimpleCardsModal({ isOpen, onClose, winningCardIds }) {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 rounded-2xl shadow-2xl border border-white/20 p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto relative text-white"
