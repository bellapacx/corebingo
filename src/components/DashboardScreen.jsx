...
if (isWinner) {
  ...
  return (
     <div className="w-screen h-screen bg-gradient-to-br from-blue-950 via-slate-900 to-indigo-950 p-8 text-white font-sans overflow-hidden backdrop-blur-lg">
      {/* Header */}
      ...
      <div className="flex space-x-8 h-[calc(100vh-160px)]">
        {/* Left Panel */}
        <div className="w-80 bg-white/20 backdrop-blur-xl rounded-2xl p-6 flex flex-col justify-between shadow-2xl border border-white/30">
          <div>
          ...
          <div className="mt-6 mb-2 p-4 border border-white/30 rounded-md bg-white/10 backdrop-blur max-w-md w-full">
        ...
        {/* Bingo Numbers Grid */}
        <div className="flex-1 p-6 rounded-2xl bg-white/10 backdrop-blur-md shadow-xl border border-white/20 overflow-y-auto scrollbar-hide">
